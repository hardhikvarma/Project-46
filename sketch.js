...
function preload(){
  ...
  trex_running = loadAnimation("./assets/shichan.png");
  
  groundImage = loadImage("./assets/ground.png");
  
  cloudImage = loadImage("./assets/cloud.png");
  
  obstacle01 = loadImage("./assets/obstacle01.png");
  ...
  if(frameCount % 120 === 0) {
    ...
    switch(rand) {
      case 1: obstacle.addImage(obstacle01);
              break;
     case 2: obstacle.addImage(obstacle01);
              break;
      default: break;
    }
